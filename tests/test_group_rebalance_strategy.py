...
def test_should_rebalance_by_group_weight_thresholds() -> None:
    ...
    strat = GroupedEqualWeightRebalanceStrategy(groups, RebalanceParams(lower_weight=0.15, upper_weight=0.35))
...
def test_backtest_rebalances_only_when_triggered() -> None:
    ...
    strat = GroupedEqualWeightRebalanceStrategy(groups, RebalanceParams(0.15, 0.35))
